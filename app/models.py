...
class Users(db.Model):
    ...
    def __init__(self, first_name, last_name,age,weight,username, password, email, gender, height, weight_goal):
...
class SquatSession(db.Model):
    ...
    def __init__(self, user_id, start_time, end_time, rep, set_number, no_of_kneesinward, no_of_toolow,  no_of_bentforward,  no_of_heelsraised, no_of_mistakes):
        self.user_id = user_id
...
class CurlSession(db.Model):
    ...
    def __init__(self, user_id, start_time, end_time, rep, set_number, no_of_backbent, no_of_wristbent,  no_of_elbowflare,  no_of_shouldershrug, no_of_mistakes):
        self.user_id = user_id
        self.start_time = start_time
        self.end_time = end_time
        self.date = date
...
class OhpSession(db.Model):
    ...
    def __init__(self, user_id, start_time, end_time, rep, set_number, no_of_bentknees, no_of_elbowposition, no_of_archedback, no_of_mistakes):
        self.user_id = user_id
        self.start_time = start_time
        self.end_time = end_time
        self.date = date
...
class PlankSession(db.Model):
    ...
    def __init__(self, user_id, start_time, end_time, rep, set_number, no_of_backbentupwards, no_of_stomachinwards,  no_of_kneesbent,  no_of_lookingstraight, no_of_loweringhips, no_of_archingback, no_of_mistakes):
        self.user_id = user_id
        self.start_time = start_time
        self.end_time = end_time
        self.date = date
